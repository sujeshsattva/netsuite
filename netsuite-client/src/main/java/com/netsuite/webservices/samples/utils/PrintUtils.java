...
import com.netsuite.suitetalk.proxy.v2020_1.lists.accounting.BudgetCategory;
import com.netsuite.suitetalk.proxy.v2020_1.lists.accounting.Currency;
import com.netsuite.suitetalk.proxy.v2020_1.lists.accounting.State;
import com.netsuite.suitetalk.proxy.v2020_1.lists.marketing.CampaignCategory;
import com.netsuite.suitetalk.proxy.v2020_1.platform.core.Record;
import com.netsuite.suitetalk.proxy.v2020_1.platform.core.SearchResult;
...
import com.netsuite.webservices.samples.Fields;
import com.netsuite.webservices.samples.io.Logger;
...
import static com.netsuite.webservices.samples.utils.IndentationUtils.getSuitableIndentation;
...
public final class PrintUtils {
    ...
    public static void printMap(Map<String, String> map) {
        ...
        for (Map.Entry<String, String> entry : map.entrySet()) {
            ...
            LOG.info(format("%1$" + indentation + "s = %2$s",
                    entry.getKey(), isEmptyString(value) ? NOT_AVAILABLE : value));
        }
    }
